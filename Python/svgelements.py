""" Holds all of the classes for creating svg tags """
...
class Line(Base):
    ...
    def createtag(self):
        """ Creates an SVG line tag from the class attributes """
...
class Text(Base):
    ...
    def createtag(self):
        """ Creates an SVG text tag from the class attributes """
...
class OpenGroup(Base):
    """ The class for an opening group tag """
    ...
    def createtag(self):
        """ Create an opening group tag from the class attributes """
...
class Animate(Base):
    """ The class for an SVG animation """
    ...
    def create_tag(self):
        """ Creates an animation tag from the class attributes """
